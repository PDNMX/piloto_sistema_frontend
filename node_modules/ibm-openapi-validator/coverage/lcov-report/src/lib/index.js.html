...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/lib</a> index.js</h1>
        <div class='clearfix'>
...
&nbsp;
module.exports = async function(input, defaultMode = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span> {
