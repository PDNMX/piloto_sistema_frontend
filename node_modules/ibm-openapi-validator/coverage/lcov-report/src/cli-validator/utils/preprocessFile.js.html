...
<head>
    <title>Code coverage report for src/cli-validator/utils/preprocessFile.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/cli-validator/utils</a> preprocessFile.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">94x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">module.exports = function(originalFile) {
  let processedFile;
&nbsp;
