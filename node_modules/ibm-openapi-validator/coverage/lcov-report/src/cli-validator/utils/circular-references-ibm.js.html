...
<head>
    <title>Code coverage report for src/cli-validator/utils/circular-references-ibm.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/cli-validator/utils</a> circular-references-ibm.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">9x</span>
<span class="cline-any cline-yes">9x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// find the circular references,
// correct them,
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!keys.length) {
<span class="cstat-no" title="statement not covered" >      return null;</span>
    }
&nbsp;
