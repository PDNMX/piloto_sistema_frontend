...
<head>
    <title>Code coverage report for src/cli-validator/utils/validator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/cli-validator/utils</a> validator.js</h1>
        <div class='clearfix'>
...
<a name='L133'></a><a href='#L133'>133</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">9x</span>
...
<span class="cline-any cline-yes">99x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const merge = require('deepmerge');
...
&nbsp;
  ...
  if (allSpecs.circular) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (problem.errors.length) {
<span class="cstat-no" title="statement not covered" >      validationResults.errors[key] = [...problem.errors];</span>
<span class="cstat-no" title="statement not covered" >      validationResults.error = true;</span>
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (problem.warnings.length) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (structuralKeys.length) {
<span class="cstat-no" title="statement not covered" >    validationResults.error = true;</span>
<span class="cstat-no" title="statement not covered" >    validationResults.errors['structural-validator'] = structuralKeys.map(</span>
<span class="fstat-no" title="function not covered" >      ke</span>y =&gt; (<span class="cstat-no" title="statement not covered" >{</span>
