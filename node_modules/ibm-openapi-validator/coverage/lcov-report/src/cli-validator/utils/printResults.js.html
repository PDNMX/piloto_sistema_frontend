...
<head>
    <title>Code coverage report for src/cli-validator/utils/printResults.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/cli-validator/utils</a> printResults.js</h1>
        <div class='clearfix'>
...
<a name='L128'></a><a href='#L128'>128</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">8x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const each = require('lodash/each');
...
&nbsp;
  ...
  if (reportingStats &amp;&amp; (stats.errors.total || <span class="branch-2 cbranch-no" title="branch not covered" >stats.warnings.total)</span>) {
...
&nbsp;
    types.forEach(type =&gt; {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (stats[type].total) {
