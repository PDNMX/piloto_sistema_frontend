...
<head>
    <title>Code coverage report for src/cli-validator/runValidator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/cli-validator</a> runValidator.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">88.54% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>139/157</span>
            </div>
...
<a name='L333'></a><a href='#L333'>333</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (args[0] === 'init') {
<span class="cstat-no" title="statement not covered" >    return await init.printDefaults(chalk);</span>
  }
&nbsp;
  // if the 'migrate' command is given, run the module
  // and exit the program
  <span class="missing-if-branch" title="if path not taken" >I</span>if (args[0] === 'migrate') {
<span class="cstat-no" title="statement not covered" >    return await init.migrate(chalk);</span>
  }
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (filteredFiles.length) <span class="cstat-no" title="statement not covered" >console.log();</span>
  filteredFiles.forEach(<span class="fstat-no" title="function not covered" >fi</span>lename =&gt; {
...
&nbsp;
  ...
  args.forEach(arg =&gt; {
    if (ext.supportedFileExtension(arg, supportedFileTypes)) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!unsupportedExtensionsFound) console.log();
...
&nbsp;
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (fileExtension === 'yaml' || fileExtension === 'yml') {
        input = readYaml.safeLoad(originalFile);
      }
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof input !== 'object') {
<span class="cstat-no" title="statement not covered" >        throw `The given input in ${validFile} is not a valid object.`;</span>
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      printError(chalk, 'There was a problem with spectral.', getError(err));</span>
...
<span class="cstat-no" title="statement not covered" >      printError(chalk, 'There was a problem with a validator.', getError(err));</span>
<span class="cstat-no" title="statement not covered" >      if (debug) {</span>
<span class="cstat-no" title="statement not covered" >        console.log(err.stack);</span>
      }
<span class="cstat-no" title="statement not covered" >      exitCode = 1;</span>
...
&nbsp;
    if (jsonOutput) {
      ...
      if (results.error || results.warning) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (validFile === last(filesToValidate)) console.log();
      }
    }
  }
&nbsp;
...
function getError(err) {
  return err.message || <span class="branch-1 cbranch-no" title="branch not covered" >err;</span>
}
&nbsp;
