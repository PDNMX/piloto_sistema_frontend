...
<head>
    <title>Code coverage report for src/plugins/validation/swagger2/semantic-validators/form-data.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">src/plugins/validation/swagger2/semantic-validators</a> form-data.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">17190x</span>
<span class="cline-any cline-yes">17190x</span>
<span class="cline-any cline-yes">9960x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7230x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">6948x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">6948x</span>
<span class="cline-any cline-yes">6948x</span>
<span class="cline-any cline-yes">17124x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">66x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Assertions are in the following order ( bailing as soon as we hit the firs assertion )
//
&nbsp;
// Assertation typo
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!isObject(resolvedSpec)) {
...
&nbsp;
  ...
  function walk(obj, path) {
    path = path || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (keys) {
...
&nbsp;
    if (formDataWithTypos.length) {
      params.forEach((param, i) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (param['in'] !== 'formdata') {
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
        messages.addMessage(
          `${path.join('.')}.${i}`,
...
&nbsp;
  ...
  function <span class="fstat-no" title="function not covered" >assertationOne(</span>params, path) {
    // Assertion 1
    const inBodyIndex = <span class="cstat-no" title="statement not covered" >params.findIndex(</span>
<span class="fstat-no" title="function not covered" >      p </span>=&gt; <span class="cstat-no" title="statement not covered" >isObject(p) &amp;&amp; p['in'] === 'body'</span>
    );
    const formData = <span class="cstat-no" title="statement not covered" >params.filter(<span class="fstat-no" title="function not covered" >p </span>=&gt; <span class="cstat-no" title="statement not covered" >isObject(p) &amp;&amp; p['in'] === 'formData')</span>;</span>
    const hasFormData = <span class="cstat-no" title="statement not covered" >!!formData.length;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (~inBodyIndex &amp;&amp; hasFormData) {</span>
      // We"ll blame the `in: body` parameter
      const pathStr = <span class="cstat-no" title="statement not covered" >`${path.join('.')}.${inBodyIndex}`;</span>
<span class="cstat-no" title="statement not covered" >      messages.addMessage(</span>
        pathStr,
