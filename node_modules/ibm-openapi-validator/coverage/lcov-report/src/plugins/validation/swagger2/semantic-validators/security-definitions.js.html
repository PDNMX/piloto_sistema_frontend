...
<head>
    <title>Code coverage report for src/plugins/validation/swagger2/semantic-validators/security-definitions.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">src/plugins/validation/swagger2/semantic-validators</a> security-definitions.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">59x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Assertation 1: security definition must have type one of "apiKey" || "oauth2" || "basic"
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (auths.indexOf(type) === -1) {
<span class="cstat-no" title="statement not covered" >      messages.addMessageWithAuthId(</span>
        path,
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (authIn !== 'query' &amp;&amp; authIn !== 'header') {
<span class="cstat-no" title="statement not covered" >          messages.addMessageWithAuthId(</span>
            path,
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!security.name) {
<span class="cstat-no" title="statement not covered" >          messages.addMessageWithAuthId(</span>
            path,
      ...
      else <span class="missing-if-branch" title="else path not taken" >E</span>if (type === OAUTH2) {
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (oauth2Flows.indexOf(flow) === -1) {
<span class="cstat-no" title="statement not covered" >          messages.addMessageWithAuthId(</span>
            path,
        ...
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (flow === IMPLICIT) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!authorizationUrl) {
<span class="cstat-no" title="statement not covered" >            messages.addMessageWithAuthId(</span>
              path,
        ...
        } else <span class="cstat-no" title="statement not covered" >if (flow === ACCESS_CODE) {</span>
<span class="cstat-no" title="statement not covered" >          if (!authorizationUrl || !tokenUrl) {</span>
<span class="cstat-no" title="statement not covered" >            messages.addMessageWithAuthId(</span>
              path,
        ...
        } else <span class="cstat-no" title="statement not covered" >if (flow === PASSWORD) {</span>
<span class="cstat-no" title="statement not covered" >          if (!tokenUrl) {</span>
<span class="cstat-no" title="statement not covered" >            messages.addMessageWithAuthId(</span>
              path,
        ...
        } else <span class="cstat-no" title="statement not covered" >if (flow === APPLICATION) {</span>
<span class="cstat-no" title="statement not covered" >          if (!tokenUrl) {</span>
<span class="cstat-no" title="statement not covered" >            messages.addMessageWithAuthId(</span>
              path,
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof scopes !== 'object') {
<span class="cstat-no" title="statement not covered" >          messages.addMessageWithAuthId(</span>
            path,
