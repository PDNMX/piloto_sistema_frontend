...
<head>
    <title>Code coverage report for src/plugins/validation/swagger2/semantic-validators/operations-ibm.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">src/plugins/validation/swagger2/semantic-validators</a> operations-ibm.js</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >      return;</span>
    ...
    each(pathOps, (op, opKey) =&gt; {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!op || op['x-sdk-exclude'] === true) {
...
&nbsp;
        ...
        if (path.parameters) {
          path.parameters.forEach(parameter =&gt; {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (parameter.in === 'body') {
