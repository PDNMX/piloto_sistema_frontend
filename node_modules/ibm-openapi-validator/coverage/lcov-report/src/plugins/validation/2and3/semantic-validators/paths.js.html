...
<head>
    <title>Code coverage report for src/plugins/validation/2and3/semantic-validators/paths.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">src/plugins/validation/2and3/semantic-validators</a> paths.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">113x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Assertation 1:
...
&nbsp;
  each(resolvedSpec.paths, (path, pathName) =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!path || !pathName) {
...
&nbsp;
    const availableParameters = parametersFromPath.map((param, i) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!isObject(param)) {
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
...
&nbsp;
    ...
    each(parametersFromPath, (parameterDefinition, i) =&gt; {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (i !== nameAndInComboIndex &amp;&amp; parameterDefinition.in) {
...
&nbsp;
    ...
    each(availableParameters, (parameterDefinition, i) =&gt; {
      if (
        ...
        messages.addMessage(
          parameterDefinition.$$path || <span class="branch-1 cbranch-no" title="branch not covered" >`paths.${pathName}.parameters[${i}]`,</span>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (pathTemplates) {
...
<span class="cstat-no" title="statement not covered" >      each(availableParameters, <span class="fstat-no" title="function not covered" >(p</span>arameterDefinition, i) =&gt; {</span>
        // Assertation 1, for cases when no templating is present on the path
<span class="cstat-no" title="statement not covered" >        if (parameterDefinition.in === 'path') {</span>
<span class="cstat-no" title="statement not covered" >          messages.addMessage(</span>
            `paths.${pathName}.parameters[${i}]`,
            `Path parameter was defined but never used: ${
              parameterDefinition.name
