...
<head>
    <title>Code coverage report for src/plugins/validation/2and3/semantic-validators/parameters-ibm.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">src/plugins/validation/2and3/semantic-validators</a> parameters-ibm.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">115x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">9350x</span>
...
&nbsp;
  walk(jsSpec, [], function(obj, path) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (obj['x-sdk-exclude'] === true) {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (checkStatusAuth === 'warning') {
          messageAuth =
            messageAuth +
