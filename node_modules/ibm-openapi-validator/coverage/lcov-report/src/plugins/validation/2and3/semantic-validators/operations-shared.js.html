...
<head>
    <title>Code coverage report for src/plugins/validation/2and3/semantic-validators/operations-shared.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">src/plugins/validation/2and3/semantic-validators</a> operations-shared.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">121x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Assertations
&nbsp;
...
&nbsp;
  map(resolvedSpec.paths, (path, pathKey) =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (pathKey.slice(0, 2) === 'x-') {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (checkStatusArrRes !== 'off') {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (checkStatusParamOrder !== 'off') {
