...
<head>
    <title>Code coverage report for src/plugins/validation/2and3/semantic-validators/security-ibm.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">src/plugins/validation/2and3/semantic-validators</a> security-ibm.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">9x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// from openapi spec -
// Assertation 1:
// Swagger 2
...
&nbsp;
          if (isSchemeWithNonEmptyArray) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (Array.isArray(scopes)) {
