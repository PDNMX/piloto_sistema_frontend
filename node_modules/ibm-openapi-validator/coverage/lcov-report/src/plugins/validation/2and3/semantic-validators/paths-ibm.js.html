...
<head>
    <title>Code coverage report for src/plugins/validation/2and3/semantic-validators/paths-ibm.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">src/plugins/validation/2and3/semantic-validators</a> paths-ibm.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">113x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Assertation 1. If a path has a parameter, all operations must have a parameter of type
      ...
      if (operationKeys.length &gt; 1) {
        parameters.forEach(parameter =&gt; {
          ...
          if (operationPathParams.length === 1) {
            ...
            const checkStatus = config.duplicate_path_parameter || <span class="branch-1 cbranch-no" title="branch not covered" >'off';</span>
...
&nbsp;
    ...
    if (checkStatus != 'off') {
      ...
      // functionality
      <span class="missing-if-branch" title="else path not taken" >E</span>if (config.paths_case_convention) {
        const checkStatusPath = config.paths_case_convention[0];
        <span class="missing-if-branch" title="else path not taken" >E</span>if (checkStatusPath !== 'off') {
