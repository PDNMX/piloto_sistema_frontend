...
<head>
    <title>Code coverage report for src/plugins/validation/2and3/semantic-validators/security-definitions-ibm.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">src/plugins/validation/2and3/semantic-validators</a> security-definitions-ibm.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">108x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// From swagger-tools -
...
&nbsp;
  each(securityDefinitions, (scheme, name) =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (name.slice(0, 2) === 'x-') <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
    definedSchemes[name] = {};
...
&nbsp;
    ...
    if (scheme.type.toLowerCase() === 'oauth2') {
      if (isOAS3) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (scheme.flows) {
          each(scheme.flows, (flow, flowType) =&gt; {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (flow.scopes) {
...
&nbsp;
  ...
  each(paths, (operations, pathName) =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (pathName.slice(0, 2) === 'x-') <span class="cstat-no" title="statement not covered" >return;</span>
    each(operations, (operation, opName) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (opName.slice(0, 2) === 'x-') <span class="cstat-no" title="statement not covered" >return;</span>
...
&nbsp;
          if (type.toLowerCase() === 'oauth2') {
            scopesArray.forEach(scope =&gt; {
              <span class="missing-if-branch" title="else path not taken" >E</span>if (definedScopes[scope]) {
