...
<head>
    <title>Code coverage report for src/plugins/utils/findOctetSequencePaths.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/plugins/utils</a> findOctetSequencePaths.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">13x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Finds octet sequences (type: string, format: binary) in schemas including
...
function arrayOctetSequences(resolvedSchema, path) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (arrayItems !== undefined) {
    ...
    try {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (err instanceof TypeError) {
        const escapedPaths = [];
