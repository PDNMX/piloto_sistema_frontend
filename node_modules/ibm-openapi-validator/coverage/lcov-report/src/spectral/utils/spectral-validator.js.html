...
<head>
    <title>Code coverage report for src/spectral/utils/spectral-validator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/spectral/utils</a> spectral-validator.js</h1>
        <div class='clearfix'>
...
<a name='L86'></a><a href='#L86'>86</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">9x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1188x</span>
<span class="cline-any cline-yes">1187x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const MessageCarrier = require('../../plugins/utils/messageCarrier');
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (results) {
    for (const validationResult of results) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (validationResult) {
...
&nbsp;
        if (typeof severity === 'number' &amp;&amp; code &amp;&amp; message &amp;&amp; path) {
          ...
          } else <span class="missing-if-branch" title="else path not taken" >E</span>if (severity === 0) {
            // error
            messages.addMessage(path, message, 'error');
          }
        } else {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (debug) {
            console.log(
