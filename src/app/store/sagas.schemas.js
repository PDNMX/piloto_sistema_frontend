...
import {
	...
	USER_VIGENCIACONTRASENA_SET,
	REQUEST_PERMISOS_SISTEMA_SET
} from './mutations';
	...
	while (true) {
		...
		if (token) {
			...
			try {
				...
				const { status, data } = yield axios.post(ur + urlValidation, SCHEMA, {
					headers: {
...
export function* fillAllProviders() {
	while (true) {
		...
		const respuestaArray = yield axios.post(ur + `/getProvidersFull`, query, {
			headers: {
				'Content-Type': 'application/json',
				Accept: 'application/json',
				Authorization: `Bearer ${token}`
...
export function* fillAllUsers() {
	while (true) {
		...
		const respuestaArray = yield axios.post(ur + `/getUsersAll`, query, {
			headers: {
				'Content-Type': 'application/json',
				Accept: 'application/json',
				Authorization: `Bearer ${token}`
	...
	while (true) {
		...
		if (token) {
			...
			try {
				...
				const { status, data } = yield axios.delete(ur + `/deleteUser`, {
					data: { request },
					headers: {
						'Content-Type': 'application/json',
						Accept: 'application/json',
...
export function* deleteProvider() {
	while (true) {
		...
		const { status, data } = yield axios.delete(ur + `/deleteProvider`, {
			data: { request },
			headers: {
				'Content-Type': 'application/json',
				Accept: 'application/json',
...
export function* editUser() {
	while (true) {
		...
		usuarioJson['user'] = payload.idUser;
		try {
			const { status, data } = yield axios.put(ur + `/edit/user`, usuarioJson, {
				headers: {
					'Content-Type': 'application/json',
					Accept: 'application/json',
					Authorization: `Bearer ${token}`
...
export function* creationProvider() {
	while (true) {
		...
		const { status, data } = yield axios.post(ur + `/create/provider`, usuarioJson, {
			headers: {
				'Content-Type': 'application/json',
				Accept: 'application/json',
				Authorization: `Bearer ${token}`
...
export function* editProvider() {
	while (true) {
		...
		yield put(userActions.setUserInSession(payload.idUser));
		usuarioJson['usuario'] = payload.idUser;
		const { status, data } = yield axios.put(ur + `/edit/provider`, usuarioJson, {
			headers: {
				'Content-Type': 'application/json',
				Accept: 'application/json',
				Authorization: `Bearer ${token}`
...
export function* getCatalogMunicipio() {
	while (true) {
		...
		const token = localStorage.token;
		const respuestaArray = yield axios.post(
			ur + `/getCatalogsMunicipiosPorEstado`,
			{ idEstado: idEstado },
			{
				headers: {
					'Content-Type': 'application/json',
			...
			if (values.particularSancionado.domicilioMexico) {
				...
				if (values.particularSancionado.domicilioMexico.vialidad) {
					...
					values.particularSancionado.domicilioMexico.vialidad = {
						...
						valor: values.particularSancionado.domicilioMexico.descripcionVialidad
							? values.particularSancionado.domicilioMexico.descripcionVialidad
							: ''
					};
...
export function* getListSchemaS2() {
	while (true) {
		...
		const respuestaArray = yield axios.post(ur + `/listSchemaS2`, filters, {
			headers: {
				'Content-Type': 'application/json',
				Accept: 'application/json',
				Authorization: `Bearer ${token}`
...
export function* getListSchemaS3S() {
	while (true) {
		...
		const respuestaArray = yield axios.post(ur + `/listSchemaS3S`, filters, {
			headers: {
				'Content-Type': 'application/json',
				Accept: 'application/json',
				Authorization: `Bearer ${token}`
...
export function* getListSchemaS3P() {
	while (true) {
		...
		const respuestaArray = yield axios.post(ur + `/listSchemaS3P`, filters, {
			headers: {
				'Content-Type': 'application/json',
				Accept: 'application/json',
				Authorization: `Bearer ${token}`
				...
				if (row.domicilioMexico) {
					...
					if (row.domicilioMexico.municipio) {
						...
						const respuestaArrayLocalidad = yield axios.post(
							ur + `/getCatalogsLocalidadesPorEstado`,
...
export function* fillUpdateRegS3S() {
	while (true) {
		...
		const respuestaArray = yield axios.post(ur + `/listSchemaS3S`, query, {
			headers: {
				'Content-Type': 'application/json',
				Accept: 'application/json',
				Authorization: `Bearer ${token}`
...
export function* fillUpdateRegS2() {
	while (true) {
		...
		const respuestaArray = yield axios.post(ur + `/listSchemaS2`, query, {
			headers: {
				'Content-Type': 'application/json',
				Accept: 'application/json',
				Authorization: `Bearer ${token}`
...
export function* deleteSchemaS2() {
	while (true) {
		...
		if (token) {
			...
			try {
				const { status, data } = yield axios.delete(ur + `/deleteRecordS2`, {
					data: { request },
					headers: {
						'Content-Type': 'application/json',
						Accept: 'application/json',
...
export function* deleteSchemaS3S() {
	while (true) {
		...
		if (token) {
			...
			request['usuario'] = payload.idUser;
			try {
				const { status, data } = yield axios.delete(ur + `/deleteRecordS3S`, {
					data: { request },
					headers: {
						'Content-Type': 'application/json',
						Accept: 'application/json',
...
export function* deleteSchemaS3P() {
	while (true) {
		...
		if (token) {
			...
			request['usuario'] = payload.idUser;
			try {
				const { status, data } = yield axios.delete(ur + `/deleteRecordS3P`, {
					data: { request },
					headers: {
						'Content-Type': 'application/json',
						Accept: 'application/json',
...
export function* consultBitacora() {
	while (true) {
		...
		yield put(userActions.setUserInSession(payload.idUser));
		//usuarioJson["usuario"]=payload.idUser;
		const respuestaArray = yield axios.post(ur + `/getBitacora`, usuarioJson, {
			headers: {
				'Content-Type': 'application/json',
				Accept: 'application/json',
				Authorization: `Bearer ${token}`
...
export function* ResetPassword() {
	while (true) {
		...
		try {
			status = yield axios.post(ur + `/resetpassword`, qs.stringify(requestBody), {
				headers: { validateStatus: () => true, 'Content-Type': 'application/x-www-form-urlencoded' }
			});
			//localStorage.setItem("token", token.data.access_token);
...
export function* changePassword() {
	while (true) {
		...
		try {
			status = yield axios.post(ur + `/changepassword`, usuarioJson, {
				headers: {
					'Content-Type': 'application/json',
					Accept: 'application/json',
					Authorization: `Bearer ${token}`
